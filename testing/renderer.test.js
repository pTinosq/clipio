...
test('List element creation (type)', () => {
    expect(
        renderer.create_li("Hello World", "versions").nodeName
    ).toBe("LI");

    expect(
        renderer.create_li("Hello World", "information").nodeName
    ).toBe("LI");

    expect(
        renderer.create_li("Hello World", "performance").nodeName
    ).toBe("LI");
});

test('List element creation (innerHTML)', () => {
    expect(
        renderer.create_li("Hello World", "versions").innerHTML
    ).toBe("Hello World");

    expect(
        renderer.create_li("Hello World", "information").innerHTML
    ).toBe("Hello World");

    expect(
        renderer.create_li("Hello World", "performance").innerHTML
    ).toBe("Hello World");
});

test('List pair element creation (type)', () => {
    expect(
        renderer.create_li_pair("Hello", "World", "versions").nodeName
    ).toBe("LI");
...
test('List pair element creation (class) (blink=default, id=default)', () => {
    expect(
        renderer.create_li_pair("Hello", "World", "versions").className
    ).toBe("");
...
test('List pair element creation (id) (blink=true, id=default)', () => {
    expect(
        renderer.create_li_pair("Hello", "World", "versions", true).id
    ).toBe("null");
...
test('List pair element creation (class) (blink=true, id="test")', () => {
    expect(
        renderer.create_li_pair("Hello", "World", "versions", true, "test").className
    ).toBe("blink");

    expect(
        renderer.create_li_pair("Hello", "World", "information", true, "test").className
    ).toBe("blink");

    expect(
        renderer.create_li_pair("Hello", "World", "performance", true, "test").className
    ).toBe("blink");
});
